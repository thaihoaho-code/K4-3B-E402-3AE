...
- **Willing users + kế hoạch vòng validation:** **Phan Ngọc Hòa (level 2), Nguyễn Đăng Tuấn Huy (level 2), Lê Minh Sang (chung lớp E402), Nguyễn Việt Hoàng  (chung lớp E402), Nguyễn Tiến Phát  (chung lớp E402)**. **Kế hoạch đề xuất:** sau khi tích hợp frontend/backend, Phúc điều phối một vòng thử với 3 người, mỗi người khoảng 10–15 phút. Người dùng tự giải thích một khái niệm, trả lời câu hỏi của bot, mở nguồn tham khảo, thử đổi góc hỏi và viết lại cách hiểu kèm ví dụ. Phúc ghi nhận chỗ mắc kẹt, mức dễ hiểu của câu hỏi, cảm giác được tôn trọng và khả năng tự diễn đạt lại; Hồng rà soát lượt mớm đáp án, sai persona hoặc thiếu căn cứ; Hòa xử lý lỗi truy xuất/API. Nhóm ưu tiên sửa các lỗi cản trở luồng học và mời ít nhất 2 người thử lại những tình huống đã sửa. Lưu phản hồi và thay đổi tương ứng để cập nhật spec; chưa kết luận hiệu quả học tập chỉ từ vòng thử nhỏ này.
